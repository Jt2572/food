    ...
    return (
        <div >
            ...
            <div className="flex flex-col  ">
                    ...
                    <div className="flex justify-center p-8"> Create Recipe  </div>
                ...
                <div className="flex justify-center ">
                    <div class="block p-6 rounded-lg shadow-lg bg-white max-w-md">
                        <form>
                            ...
                            <div class="form-group mb-6">
                                <textarea
                                    class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300  rounded  transition  ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleFormControlTextarea13"
                                    rows="3"
                                    placeholder="Message"
                                ></textarea>
                            </div>
