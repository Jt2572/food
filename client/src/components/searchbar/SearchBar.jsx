        ...
        <div>
            ...
            <form className="flex items-center">
                ...
                <div className="relative w-full">
                    <input type="text" id="search" className=" active:shadow-[inset_0_0px_10px_rgba(255,174,0,1)] bg-gray-50 border border-yellow-900 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-2 p-1  " placeholder="Search..." required="" />
                </div>
