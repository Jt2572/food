...
function Card({ name, image, score, diet, id }) {
    ...
    return (
        ...
        <div className="container mx-5 my-4 flex  justify-center">
            <div className=" flex flex-col justify-center w-64  shadow-lg shadow-current">

                <img src={image} class="w-full" alt="..." />
                <div className=" flex justify-center text-sm text-gray-500 font-bold tracking-widest mb-2 uppercase">{name}</div>
                <p className="flex justify-center">{diet?.map(d => d)}</p>
